...
;(function($, window, document, undefined) {
    ...
    */
    fn.on_stop_drag = function(event, ui) {
        ...
        var sticky = this.$player;
        var sticky_coords = sticky.coords().grid;
        
        if(window.stickyBoardApplication){
        	window.stickyBoardApplication.move_sticky({
        		'assigned_id': sticky.attr("data-index"),
        		'position_x' : sticky_coords.col,
        		'position_y' : sticky_coords.row
        	});
        }
