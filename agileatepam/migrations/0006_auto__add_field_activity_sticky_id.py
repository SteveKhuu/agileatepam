...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Activity.sticky_id'
        db.add_column('agileatepam_activity', 'sticky_id',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=1000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Activity.sticky_id'
        db.delete_column('agileatepam_activity', 'sticky_id')
