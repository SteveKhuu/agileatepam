...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('agileatepam_activity', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('event_time', self.gf('django.db.models.fields.DateTimeField')()),
            ('note_id', self.gf('django.db.models.fields.CharField')(max_length=1000)),
            ('configuration', self.gf('django.db.models.fields.CharField')(max_length=5000)),
        ))
        db.send_create_signal('agileatepam', ['Activity'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('agileatepam_activity')
