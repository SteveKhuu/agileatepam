...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Comment.created_datetime'
        db.alter_column('agileatepam_comment', 'created_datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Comment.created_datetime'
        db.alter_column('agileatepam_comment', 'created_datetime', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        'agileatepam.activity': {
            ...
            'sticky_id': ('django.db.models.fields.CharField', [], {'max_length': '1000'}),
